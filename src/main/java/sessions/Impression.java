...
public class Impression extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public sessions.PhoneType phone_type;
   ...
   */
  public Impression(sessions.ImpressionType impression_type, sessions.Action action, sessions.ActionName action_name, java.util.List<java.lang.Long> id, java.lang.Long timestamp, java.lang.CharSequence ab, sessions.Vertical vertical, java.lang.Integer start_index, java.lang.Integer total, java.lang.CharSequence domain, java.lang.Double lat, java.lang.Double lon, java.lang.CharSequence address, java.lang.CharSequence city, java.lang.CharSequence zip, java.lang.CharSequence dma, java.lang.CharSequence state, sessions.PhoneType phone_type) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: impression_type = (sessions.ImpressionType)value$; break;
    case 1: action = (sessions.Action)value$; break;
    case 2: action_name = (sessions.ActionName)value$; break;
    case 3: id = (java.util.List<java.lang.Long>)value$; break;
    case 4: timestamp = (java.lang.Long)value$; break;
    case 5: ab = (java.lang.CharSequence)value$; break;
    case 6: vertical = (sessions.Vertical)value$; break;
    ...
    case 17: phone_type = (sessions.PhoneType)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public sessions.ImpressionType getImpressionType() {
   ...
   */
  public void setImpressionType(sessions.ImpressionType value) {
   ...
   */
  public sessions.Action getAction() {
    return action;
  }
   ...
   * @param value the value to set.
   */
  public void setAction(sessions.Action value) {
    this.action = value;
  }
   ...
   */
  public sessions.ActionName getActionName() {
    return action_name;
  }
   ...
   * @param value the value to set.
   */
  public void setActionName(sessions.ActionName value) {
   ...
   */
  public sessions.Vertical getVertical() {
    return vertical;
  }
   ...
   * @param value the value to set.
   */
  public void setVertical(sessions.Vertical value) {
    this.vertical = value;
  }
   ...
   */
  public sessions.PhoneType getPhoneType() {
    return phone_type;
  }
   ...
   * @param value the value to set.
   */
  public void setPhoneType(sessions.PhoneType value) {
    this.phone_type = value;
  }

  /** Creates a new Impression RecordBuilder */
  public static sessions.Impression.Builder newBuilder() {
    return new sessions.Impression.Builder();
  }
  
  /** Creates a new Impression RecordBuilder by copying an existing Builder */
  public static sessions.Impression.Builder newBuilder(sessions.Impression.Builder other) {
    return new sessions.Impression.Builder(other);
  }
  
  /** Creates a new Impression RecordBuilder by copying an existing Impression instance */
  public static sessions.Impression.Builder newBuilder(sessions.Impression other) {
    return new sessions.Impression.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Impression>
    ...
    private sessions.ImpressionType impression_type;
    private sessions.Action action;
    private sessions.ActionName action_name;
    private java.util.List<java.lang.Long> id;
    private long timestamp;
    private java.lang.CharSequence ab;
    private sessions.Vertical vertical;
    ...
    private sessions.PhoneType phone_type;

    /** Creates a new Builder */
    private Builder() {
      super(sessions.Impression.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(sessions.Impression.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Impression instance */
    private Builder(sessions.Impression other) {
            super(sessions.Impression.SCHEMA$);
    ...
    /** Sets the value of the 'impression_type' field */
    public sessions.Impression.Builder setImpressionType(sessions.ImpressionType value) {
    ...
    public sessions.Impression.Builder clearImpressionType() {
    ...
    /** Sets the value of the 'action' field */
    public sessions.Impression.Builder setAction(sessions.Action value) {
    ...
    public sessions.Impression.Builder clearAction() {
      action = null;
    ...
    /** Sets the value of the 'action_name' field */
    public sessions.Impression.Builder setActionName(sessions.ActionName value) {
    ...
    public sessions.Impression.Builder clearActionName() {
      action_name = null;
    ...
    /** Sets the value of the 'id' field */
    public sessions.Impression.Builder setId(java.util.List<java.lang.Long> value) {
    ...
    public sessions.Impression.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'timestamp' field */
    public sessions.Impression.Builder setTimestamp(long value) {
    ...
    public sessions.Impression.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'ab' field */
    public sessions.Impression.Builder setAb(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearAb() {
      ab = null;
    ...
    /** Sets the value of the 'vertical' field */
    public sessions.Impression.Builder setVertical(sessions.Vertical value) {
    ...
    public sessions.Impression.Builder clearVertical() {
      vertical = null;
    ...
    /** Sets the value of the 'start_index' field */
    public sessions.Impression.Builder setStartIndex(int value) {
    ...
    public sessions.Impression.Builder clearStartIndex() {
    ...
    /** Sets the value of the 'total' field */
    public sessions.Impression.Builder setTotal(int value) {
    ...
    public sessions.Impression.Builder clearTotal() {
    ...
    /** Sets the value of the 'domain' field */
    public sessions.Impression.Builder setDomain(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearDomain() {
      domain = null;
    ...
    /** Sets the value of the 'lat' field */
    public sessions.Impression.Builder setLat(double value) {
    ...
    public sessions.Impression.Builder clearLat() {
    ...
    /** Sets the value of the 'lon' field */
    public sessions.Impression.Builder setLon(double value) {
    ...
    public sessions.Impression.Builder clearLon() {
    ...
    /** Sets the value of the 'address' field */
    public sessions.Impression.Builder setAddress(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearAddress() {
      address = null;
    ...
    /** Sets the value of the 'city' field */
    public sessions.Impression.Builder setCity(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearCity() {
      city = null;
    ...
    /** Sets the value of the 'zip' field */
    public sessions.Impression.Builder setZip(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearZip() {
      zip = null;
    ...
    /** Sets the value of the 'dma' field */
    public sessions.Impression.Builder setDma(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearDma() {
      dma = null;
    ...
    /** Sets the value of the 'state' field */
    public sessions.Impression.Builder setState(java.lang.CharSequence value) {
    ...
    public sessions.Impression.Builder clearState() {
      state = null;
    ...
    /** Sets the value of the 'phone_type' field */
    public sessions.Impression.Builder setPhoneType(sessions.PhoneType value) {
    ...
    public sessions.Impression.Builder clearPhoneType() {
      phone_type = null;
    ...
    public Impression build() {
      try {
        ...
        record.impression_type = fieldSetFlags()[0] ? this.impression_type : (sessions.ImpressionType) defaultValue(fields()[0]);
        record.action = fieldSetFlags()[1] ? this.action : (sessions.Action) defaultValue(fields()[1]);
        record.action_name = fieldSetFlags()[2] ? this.action_name : (sessions.ActionName) defaultValue(fields()[2]);
        ...
        record.vertical = fieldSetFlags()[6] ? this.vertical : (sessions.Vertical) defaultValue(fields()[6]);
        ...
        record.phone_type = fieldSetFlags()[17] ? this.phone_type : (sessions.PhoneType) defaultValue(fields()[17]);
        return record;
      } catch (Exception e) {
